    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.setiRecyclerItemSelectedListener(new IRecyclerItemSelectedListener() {
            ...
            public void onItemSelectedListener(View view, int pos) {
                //Define backgroud branco prara aqueles que não estão selecionados
                for (CardView cardView:cardViewList)
                    cardView.setCardBackgroundColor(context.getResources().getColor(android.R.color.white));

                //Define background laranja para aqueles que estão selecionados
                myViewHolder.card_salon.setCardBackgroundColor(context.getResources().getColor(android.R.color.holo_orange_dark));

                //Diz para BookingActivity habilitar o botão "Próximo"
