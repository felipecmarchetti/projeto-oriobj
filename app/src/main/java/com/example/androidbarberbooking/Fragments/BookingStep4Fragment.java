...
public class BookingStep4Fragment extends Fragment {
    ...
    void confirmBooking(){
        ...
        //Criar informações do agendamento
        ...
        bookingDate.set(bookingInformation)
                .addOnSuccessListener(aVoid -> {
                    resetStaticData();
                    getActivity().finish(); //Fecha a atividade
    ...
    private void resetStaticData() {
        ...
        Common.currentDate.add(Calendar.DATE,0); //Quando já tem um agendamento atual adicionado
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Aplica o formato de data ao Confirmar
